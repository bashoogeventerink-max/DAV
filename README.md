...
This project is an end-to-end Python solution for processing, cleaning, feature engineering, and analyzing whatsapp text-data, culminating in a series of data visualizations. The author (Bas) has created a set of visualisations for the course 'Data Analysis & Visualisation' based on the group chat with his friends from their hometown 'Losser'. The dataset of this group chat contain roughly ten thousand messages which span from the period 2022 to 2025. With the aging of the group members going from 25 to 30, the group members have gone through some significant developments in their lives during this time period. Some examples of these are moving away from the hometown to work / study elsewhere or developing new relationships. The visualisations in this project have the goal to show what type of effects these type of developments have on the dynamics in the group chat of the friend group. These visualisations are ready for review in the img/final-folder. The interpretation of these graphs will be explained in the next section. After that you can find a clear overview of the project structure, a clear step-by-step on how to use this project, and an overview of the pipeline flow.
